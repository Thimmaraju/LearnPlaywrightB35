...
test.describe('Automation - Working With Elements', () => {
    ...
    test('Upload Multiple files and assert', async ({ page }) => {
        ...
        await expect.soft(page.locator('//a[@href="https://github.com/blueimp/jQuery-File-Upload/raju"]')).toBeVisible()
        ...
        await page.locator('input[type="file"]').setInputFiles(['testdata/Defect Life cycle.jpg', 'testdata/employeephoto.png', 'testdata/addemp.xlsx'])
