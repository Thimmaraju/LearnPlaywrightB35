...
const jobtitles = ["sdet1", "sdet2", "sdet3"]

for (let element of jobtitles){



    test('Verify User can Job title - '+ element, async ({ page }) => {
        // Launch the Url
        ...
        await page.locator("(//label[normalize-space(text())='Job Title']/following::input)[1]").fill(element)
